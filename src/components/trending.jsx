...
import ProductSkeleton from "../pages/testing";
...
export default function Trending() {
  ...
  return (
    <div className="w-full  bg-amber-200 py-10 md:px-4 px-3">
      ...
      {productLoaded ? (
        <div className="w-full h-full flex flex-nowrap gap-4 overflow-x-scroll scrollbar-hide  bg-primary">
